...
// Base query
$query = "SELECT * FROM products WHERE gender = 'women'";
$params = [];
...
<head>
    <meta charset="UTF-8">
    <title>Women's shoes | KickLab</title>
            ...
            <div class="col-md-10">
                ...
                <div class="sticky-filter-wrapper bg-white border-bottom py-3">
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <a href="women.php" class="btn btn-outline-success">🔧 Clear filters</a>
                    </div>
                </div>
                                ...
                                <a href="product.php?id=<?= $product['id'] ?>" class="text-decoration-none text-dark">
                                    <div class="product-image-wrapper position-relative">
                                        <img src="<?= htmlspecialchars($product['image_main']) ?>"
                                            class="card-img-top main-img" alt="<?= htmlspecialchars($product['name']) ?>">
